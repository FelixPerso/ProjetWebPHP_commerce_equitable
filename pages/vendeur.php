    ...
    <form class="formulaire" action="" method="POST">
        <div class="custom-select" style="width:300px;">
            <select id="vendeurs" name="vendeurs">
                ...
                <?php
                if($vendeurs){
                            //  Affichage des vendeurs et de leurs différentes attentes
                ...
                if ($valid) {
                    ...
                    if ($request) {
                        ...
                        foreach ($request as $requestas) {
                                        //Permet de mettre à jour les elements extraits et de les afficher sur le profil
                        ...
                        if ($stmt) {
                            echo "<p style='padding-bottom:2%; font-size:14pt;'><b>Votre cagnotte a été augmentée de $prixTot € et vos métaux recyclés ont été mis à jour.</b></p>";
                                        ...
                                        // On va soustraire la quantité du vendeur à notre quanité
